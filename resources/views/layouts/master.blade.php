...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Đăng kí</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="square"></i> <span class="align-middle">Nút bấm</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-forms.html">
              <i class="align-middle" data-feather="check-square"></i> <span class="align-middle">Khung</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="ui-cards.html">
              <i class="align-middle" data-feather="grid"></i> <span class="align-middle">Thẻ</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="coffee"></i> <span class="align-middle">Nhãn dán</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Trò chuyện</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="maps-google.html">
              <i class="align-middle" data-feather="map"></i> <span class="align-middle">Bản đồ</span>
            </a>
					</li>
				</ul>
	...
	<script>
		setTimeout(function(){
			document.getElementByClassName('login_success').style.display = 'none';
